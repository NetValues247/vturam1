<template>
    <div>
        ...
        <div class="rounded-md bg-white pb-10">
            <div class="flex-wrap justify-between hidden p-3 pt-5">
                ...
                <ModalBase v-if="showModal" @hide-modal="hideModal">
                    ...
                    <template #body>
                        ...
                        <div v-if="userstore.details.recipient_code.length > 0" class="p-3 bg-slate-300/[.35] rounded-md">{{  }}
                            <p class="font-bold">Amount will be sent to the Following Account. A flat charge of {{ userstore.details.currency}} 15 will be applied</p>
