    ...
    <div>
        ...
        <div class="rounded-md bg-gray-100 p-2">
            ...
            <div class="flex flex-wrap justify-between mt-4 px-2">
                <ActiveBoardBase :disabler="api_calling" class="w-1/5 h-32" icon="mtn.jpg" text="MTN" link="dashboard-giftingdata"  :query="{ network : 'MTN'}"/>
                <ActiveBoardBase :disabler="api_calling" class="w-1/5 h-32" icon="glo.jpg" text="GLO" link="dashboard-giftingdata"  :query="{ network : 'GLO'}"/>
                <ActiveBoardBase :disabler="api_calling" class="w-1/5 h-32" icon="airtel.jpg" text="AIRTEL" link="dashboard-giftingdata"  :query="{ network : 'AIRTEL'}"/>
                <ActiveBoardBase :disabler="api_calling" class="w-1/5 h-32" icon="9mobile.jpg" text="9MOBILE" link="dashboard-giftingdata"  :query="{ network : '9MOBILE'}"/>
            </div>
