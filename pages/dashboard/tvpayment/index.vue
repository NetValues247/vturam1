    ...
    <div>
        ...
        <div class="rounded-md bg-gray-100 p-2">
            ...
            <div class="flex flex-wrap justify-between mt-4 px-2">
                <ActiveBoardBase :disabler="api_calling" class="w-1/4 h-32" icon="gotv.jpg" text="GOTV" link="dashboard-tvpayment" :query="{ type : 'GOTV'}"/>
                <ActiveBoardBase :disabler="api_calling" class="w-1/4 h-32" icon="dstv.jpg" text="DSTV" link="dashboard-tvpayment" :query="{ type : 'DSTV'}"/>
                <ActiveBoardBase :disabler="api_calling" class="w-1/4 h-32" icon="startimes.jpg" text="STARTIME" link="dashboard-tvpayment" :query="{ type : 'STARTIME'}"/>
            </div>
