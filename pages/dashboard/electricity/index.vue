    ...
    <div>
        ...
        <div class="rounded-md bg-gray-100 p-2">
            ...
            <div class="flex flex-wrap justify-evenly gap-2 mt-4 px-2">
                <ActiveBoardBase :disabler="api_calling" class="w-1/5" icon="ikeja-electric.jpg" text="Ikeja" link="dashboard-electricity"  :query="{ disco : 'Ikeja'}"/>
                <ActiveBoardBase :disabler="api_calling" class="w-1/5" icon="ibadan-electric.jpg" text="Ibadan" link="dashboard-electricity"  :query="{ disco : 'Ibadan'}"/>
                <ActiveBoardBase :disabler="api_calling" class="w-1/5" icon="jos-electric.jpg" text="Jos" link="dashboard-electricity"  :query="{ disco : 'Jos'}"/>
                <ActiveBoardBase :disabler="api_calling" class="w-1/5" icon="kaduna-electric.jpg" text="Kaduna" link="dashboard-electricity"  :query="{ disco : 'Kaduna'}"/>
                <ActiveBoardBase :disabler="api_calling" class="w-1/5" icon="enugu-electric.jpg" text="Enugu" link="dashboard-electricity"  :query="{ disco : 'Enugu'}"/>
                <ActiveBoardBase :disabler="api_calling" class="w-1/5" icon="eko-electric.jpg" text="Eko" link="dashboard-electricity"  :query="{ disco : 'Eko'}"/>
                <ActiveBoardBase :disabler="api_calling" class="w-1/5" icon="benin-electric.jpg" text="Benin" link="dashboard-electricity"  :query="{ disco : 'Benin'}"/>
                <ActiveBoardBase :disabler="api_calling" class="w-1/5" icon="portharcourt-electric.jpg" text="Port Harcourt" link="dashboard-electricity"  :query="{ disco : 'Port Harcourt'}"/>
            </div>
