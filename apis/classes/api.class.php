...
class API extends Emailer{
    ...
    public function _getAriseDataDetails(){
        ...
        CURLOPT_HTTPHEADER => [
            "Accept: */*",
            "Authorization: Token 6ddea222106951c60a4c38fc1430ca28ff6ff2d1",
            "Token: 6ddea222106951c60a4c38fc1430ca28ff6ff2d1",
        ],
        ]);
    ...
    public function _getSimHostingDetails(){

        $curl = curl_init();

        curl_setopt_array($curl, array(
          CURLOPT_URL => "https://zwiift.com/api/vend/wallet/balance?token=$this->simhosttoken&type=plain",
          CURLOPT_RETURNTRANSFER => true,
          CURLOPT_ENCODING => '',
          CURLOPT_MAXREDIRS => 10,
          CURLOPT_TIMEOUT => 0,
    ...
    public function _getSmartSMSBalance(){

        $curl = curl_init();

        curl_setopt_array($curl, [
            CURLOPT_URL => "https://app.smartsmssolutions.com/io/api/client/v1/balance/?token=ndhFo1JbD4uea1cNFnSg3ntm5cAe4tMYuJkJGgWIYdSIYXq1Cr",
            CURLOPT_RETURNTRANSFER => true,
            CURLOPT_ENCODING => "",
            CURLOPT_MAXREDIRS => 10,
            CURLOPT_TIMEOUT => 30,
