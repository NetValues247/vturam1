...
class Admin extends Functions {
    ...
    public function profitAnalysis($conn){
        ...
        $arisedata = $this->_getAriseDataDetails();
        $simhosting = $this->_getSimHostingDetails();
        $smartsms = $this->_getSmartSMSBalance();


        $profitAnalysis["arisedata"] = json_decode($arisedata)->user->Account_Balance;
        $profitAnalysis["simhosting"] = $simhosting;
        $profitAnalysis["smartsms"] = $smartsms;
