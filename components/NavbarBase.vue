<template>
    <div :style="{ 'background-color' : appConfig.siteTheme.primaryColor }" class="h-20 py-3 flex flex-nowrap justify-between">
        <div class="flex flex-wrap px-2">
            ...
            <NuxtLink :to="{ name : 'dashboard' }" @click="showdropdown = false" class="text-md lg:text-3xl lg:ml-3 mt-2 text-white font-bold"><img class="w-[100px] lg:w-[150px]" src="../public/img/site_logo.jpeg" /></NuxtLink>
