<template>
    <form @submit.prevent="updateService">
        <div class="flex flex-nowrap justify-start lg:justify-start w-[200%] lg:w-fit bg-slate-100 gap-4 mt-3 rounded-sm p-3">
            <div class="text-sm w-[10%] overflow-x-auto font-semibold">
                {{  sn + 1 }}
            </div>
            ...
            <div class="text-sm w-[30%] overflow-x-auto font-semibold">
                <input type="number" step="0.01" min="1" disabled v-model="serviceObj.face_price" id="amount" class="p-1 rounded-md w-full ring-0 border border-gray-200" placeholder="3000" />
            </div>

            <div class="text-sm w-[30%] overflow-x-auto font-semibold">
                <input type="number" step="0.01" :min="serviceObj.face_price"  :disabled="serviceObj.pricing == 'percentage'" v-model="serviceObj.normal_price" id="amount" class="p-1 rounded-md w-full ring-0 border border-gray-200" placeholder="3000" />
            </div>

            
            <div class="text-sm w-[30%] overflow-x-auto font-semibold">
                <input type="number" step="0.01" :min="serviceObj.face_price" :disabled="serviceObj.pricing == 'percentage'" v-model="serviceObj.reseller_price" id="amount" class="p-1 rounded-md w-full ring-0 border border-gray-200" placeholder="3000" />
            </div>

            <div class="text-sm w-[30%] overflow-x-auto font-semibold">
                <input type="number" step="0.01" min="1" disabled v-model="serviceObj.face_percentage" id="amount" class="p-1 rounded-md w-full ring-0 border border-gray-200" placeholder="5.0" />
            </div>

             <div class="text-sm w-[30%] overflow-x-auto font-semibold">
                <input type="number" step="0.01" min="1" :disabled="serviceObj.pricing == 'value'" :max="serviceObj.face_percentage" v-model="serviceObj.normal_percentage" id="amount" class="p-1 rounded-md w-full ring-0 border border-gray-200" placeholder="3000" />
            </div>

            
            <div class="text-sm w-[30%] overflow-x-auto font-semibold">
                <input type="number" step="0.01" min="1" :disabled="serviceObj.pricing == 'value'" :max="serviceObj.face_percentage" v-model="serviceObj.reseller_percentage" id="amount" class="p-1 rounded-md w-full ring-0 border border-gray-200" placeholder="3000" />
            </div>
            ...
            <div class="text-center p-2 text-sm w-[30%] font-semibold">
                ...
                <p v-if="Object.keys(finalapiresponse).length > 0" class="bg-green-300 py-1 text-green-700 rounded-lg px-4 w-fit mx-auto mt-2">updated</p>
            </div> 
        </div>
    </form>
</template>
